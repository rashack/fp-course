...
replicateA ::
  ...
  -> f a
  -> f (List a)
replicateA n f = sequence $ (listh [1..n]) *> (pure f)

-- >> sequence $ (listh [1..3]) *> (ExactlyOne 7 :. ExactlyOne 8 :. ExactlyOne 9 :. Nil)
-- ExactlyOne [7,8,9,7,8,9,7,8,9]

-- >> (Full 7 :. Full 8 :. Nil) *> (ExactlyOne 7 :. ExactlyOne 8 :. ExactlyOne 9 :. Nil)
-- [ExactlyOne 7,ExactlyOne 8,ExactlyOne 9,ExactlyOne 7,ExactlyOne 8,ExactlyOne 9]
...
--filtering f l = sequence $ foldRight sel Nil l
--  where sel e a = case f e of
--          True  -> e :. a
--          False -> a

--sel f e a = case f e of
--              True  -> 

-- >> foldRight (\e a -> (ExactlyOne . even) e :. a) Nil (1 :. 2 :. Nil)
-- [ExactlyOne False,ExactlyOne True]
